...
JOIN genres ON books.genre_id = genres.genre_id
WHERE books.book_id != $bookId
  AND (books.author_id = {$book['author_id']}
       OR books.genre_id = {$book['genre_id']}
       OR (books.price BETWEEN $priceLower AND $priceUpper))
LIMIT 10
";
    ...
    <main class="flex-1 max-w-6xl mx-auto px-4">
        ...
        <div class="flex flex-col md:flex-row gap-10 mt-4">
            ...
            <div class="flex-1 flex flex-col justify-between">
                ...
                <!-- Add to Cart Button -->
                <form action="../../src/scripts/add-to-cart.php" method="POST" class="mt-6 md:mt-10">
